...
const Food = ({ image, name, id, sinhala_name }) => {
  initTE({ Ripple })
  return (
    <div class="w-[300px] h-[355px] mb-[40px] block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700 hover:cursor-pointer hover:scale-110 hover:shadow-[0px_0px_10px_5px_#0092FB]">
      <div
